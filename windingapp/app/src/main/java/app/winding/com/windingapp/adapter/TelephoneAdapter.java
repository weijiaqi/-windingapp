...
public class TelephoneAdapter extends PagerAdapter {
    private List<BasePager> basePagers;

    private boolean isDestroyItem = true;

    public TelephoneAdapter(List<BasePager> basePagers) {
    ...
    public CharSequence getPageTitle(int position) {
        return UiUtils.getStringArray(R.array.tabs_telephone)[position];
    }
}
