...
public class FenleiLeftAdapter extends RecyclerView.Adapter<FenleiLeftAdapter.ViewHolder> {
    ...
    private List<ElectricityEntity.ResultBean> list;
    //2、定义监听并设set方法
    ...
    public FenleiLeftAdapter(Context context, List<ElectricityEntity.ResultBean> list) {
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, int position) {
        ...
        viewHolder.Settlementprice.setText(String.format(UiUtils.getText(R.string.endprice), list.get(position).getPrice()));
