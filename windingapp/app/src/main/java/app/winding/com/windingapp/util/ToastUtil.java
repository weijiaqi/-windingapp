...
public class ToastUtil {
    ...
    private static int yOffset = (int) (64 * MainApplication.getAppResources().getDisplayMetrics().density + 0.5);
    ...
    private static void show(@StringRes final int resId, final int duration) {
        show(MainApplication.getAppResources().getText(resId).toString(), duration);
    }

    private static void show(@StringRes final int resId, final int duration, final Object... args) {
        show(String.format(MainApplication.getAppResources().getString(resId), args), duration);
    }
    ...
    public static void show(final CharSequence text, final int duration) {
        HANDLER.post(() -> {
            cancel();
            sToast = Toast.makeText(MainApplication.getContext(), text, duration);
    ...
    private static void show(final View view, final int duration) {
        HANDLER.post(new Runnable() {
            ...
            public void run() {
                cancel();
                sToast = new Toast(MainApplication.getContext());
                sToast.setView(view);
    ...
    private static View getView(@LayoutRes final int layoutId) {
        ...
        LayoutInflater inflate = (LayoutInflater) MainApplication.getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
