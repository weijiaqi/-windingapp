...
import app.winding.com.windingapp.util.ScreenUtil;
...
public class TabStripView extends LinearLayout implements View.OnClickListener {
    ...
    public TabStripView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mNormalTextColor = (tabTextColor != null ? tabTextColor : context.getResources().getColorStateList(R.color.abc_white));
