...
public class ElectricAdapter extends RecyclerView.Adapter<ElectricAdapter.ViewHolder> {
    ...
    private List<ElectricEntity.ResultBean> list;
    //2、定义监听并设set方法
    ...
    public ElectricAdapter(Context context, List<ElectricEntity.ResultBean> list) {
    ...
    @Override
    public ElectricAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_prepaid, viewGroup, false);
        ElectricAdapter.ViewHolder vh = new ElectricAdapter.ViewHolder(view);
    ...
    @Override
    public void onBindViewHolder(final ElectricAdapter.ViewHolder viewHolder, int position) {
